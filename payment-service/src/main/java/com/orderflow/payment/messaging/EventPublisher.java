...
/** Publishes payment result events, keyed by orderId for per-order partition ordering. */
@Component
public class EventPublisher {
  ...
  public void publish(EventMessage event) {
    kafkaTemplate.send(Topics.EVENTS_PAYMENT, event.correlationId().toString(), event);
  }
}
